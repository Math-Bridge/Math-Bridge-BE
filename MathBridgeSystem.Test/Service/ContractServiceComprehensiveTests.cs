...
//            _service = new ContractService(_contractRepo.Object, _packageRepo.Object, _sessionRepo.Object, _emailService.Object);
//        }
...
//        [Fact]
//        public async Task CreateContractAsync_DaysOfWeeksOutOfRange_ThrowsArgumentOutOfRangeException()
//        {
//            var request = new CreateContractRequest
//            {
//                Status = "pending",
...
//        [Fact]
//        public async Task CreateContractAsync_DaysOfWeeksZero_ThrowsArgumentException()
//        {
//            var request = new CreateContractRequest
//            {
//                Status = "pending",
...
//            await FluentActions.Invoking(() => _service.CreateContractAsync(request))
//                .Should().ThrowAsync<ArgumentException>().WithMessage("At least one day of the week must be selected.");
//        }
...
//            await FluentActions.Invoking(() => _service.UpdateContractStatusAsync(contractId, request, Guid.NewGuid()))
//                .Should().ThrowAsync<InvalidOperationException>().WithMessage("*Parent information is missing*");
//        }
...
//            await FluentActions.Invoking(() => _service.UpdateContractStatusAsync(contractId, request, Guid.NewGuid()))
//                .Should().ThrowAsync<InvalidOperationException>().WithMessage("*Child information is missing*");
//        }
...
//            await FluentActions.Invoking(() => _service.UpdateContractStatusAsync(contractId, request, Guid.NewGuid()))
//                .Should().ThrowAsync<InvalidOperationException>().WithMessage("*Package information is missing*");
//        }
...
//            await FluentActions.Invoking(() => _service.UpdateContractStatusAsync(contractId, request, Guid.NewGuid()))
//                .Should().ThrowAsync<InvalidOperationException>().WithMessage("*Main tutor information is missing*");
//        }
//    }
//}
