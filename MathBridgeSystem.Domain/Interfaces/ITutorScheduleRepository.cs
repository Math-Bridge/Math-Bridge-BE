...
namespace MathBridgeSystem.Domain.Interfaces
{
    public interface ITutorScheduleRepository
    {
        ...
        Task<List<TutorSchedule>> SearchAvailableTutorsAsync(byte? daysOfWeek, TimeOnly? startTime, TimeOnly? endTime, bool? canTeachOnline, bool? canTeachOffline, DateTime? effectiveDate);
